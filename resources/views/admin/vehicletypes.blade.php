            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Vehicle Types</h3>
                        ...
                        <div class="col-lg-4">
                            <div class="card shadow-sm h-100">
                                <div class="card-header">
                                    <h5 class="mb-0">Add Vehicle Types</h5>
                                </div>

                                <form method="POST" action="{{ route('vehicletype.add') }}">
                                    @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#rolesTable').DataTable({
                ...
                ajax: {
                    url: "{{ url('/api/listVehicletypes/datatable') }}",
                    type: "GET"
                },
                columns: [{
                        data: 'id',
                    ...
                    <button class="btn btn-sm btn-primary editBtn"
                        data-id="${data.id}"
                        data-name="${data.vehicle_type_name}">
